...
-- a	=>  Location: PIN_E5,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF lab04_2 IS
...
-- Equation(s):
-- \Y~0_combout\ = (\d~input_o\ & ((\c~input_o\) # ((!\a~input_o\ & !\b~input_o\)))) # (!\d~input_o\ & ((\b~input_o\) # (\a~input_o\ $ (!\c~input_o\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1111111001010011",
